...
class VersionEntry implements \BinStruct {
	...
	function __construct() {
		...
		$this->values["dvs_mtime"] = \IntVal::uint64LE();
		...
		$this->values["dvs_size"] = \IntVal::uint64LE();
		$this->values["dvs_created_epoch"] = \IntVal::uint64LE();
		$this->values["dvs_type"] = \IntVal::uint8();
		$this->values["dvs_stored"] = \IntVal::uint8();
		$this->values["dc_id"] = \IntVal::uint64LE();
	}
